...
public class CutDownCouponStrategy extends AbstractCouponStrategy {
    ...
    public boolean canUse(CourseOrderVO orderVO, Coupon coupon) {
        ...
        // 判断满减策略
        return super.canUse(orderVO, coupon) && orderVO.getOrigin() >= Integer.parseInt(String.valueOf(threshold));
    }

    @Override
    public int useCoupon(CourseOrderVO orderVO, Coupon coupon) {
        Integer cutDown = Integer.parseInt(String.valueOf(JSONHelper.getByProperty(coupon.getMetadata(), "cutDown")));
