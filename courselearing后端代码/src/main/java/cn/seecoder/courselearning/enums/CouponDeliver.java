...
public enum CouponDeliver {
    SINGLE("发放给单个用户", ApplicationContextInjector.applicationContext.getBean(SingleUserDeliverStrategy.class)),
    COURSE_LIKE("发放给某课程点赞的用户", ApplicationContextInjector.applicationContext.getBean(CourseLikeDeliverStrategy.class)),
    ALL("发放给全体用户", ApplicationContextInjector.applicationContext.getBean(AllUserDeliverStrategy.class));
